...
uint8_t  p0[36]={0};  
uint8_t  p1[28]={"时间:2013-12-15 12:30:00\r\n"};
uint8_t  p2[32]={"              1     20    20 \r\n"};
 /*******************************************************************************
...
void SearchPrintMealID(uint8_t MealID)
{
  /*如果有则赋值相关的餐品ID的数量*/
    switch(MealID)
    {
      ...
      case 0x02:
      {
          memcpy(p2,mealname_2nd,sizeof(mealname_2nd));
      }break; 
      case 0x03:
      {
          memcpy(p2,mealname_3rd,sizeof(mealname_3rd));
      }break; 
      case 0x04:
      {
          memcpy(p2,mealname_4th,sizeof(mealname_4th));
      }break; 
      default:break;      
    }
}
