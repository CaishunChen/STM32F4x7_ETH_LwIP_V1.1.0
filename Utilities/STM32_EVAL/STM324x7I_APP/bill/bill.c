...
void SetBills(void)
{
	uint8_t bufCmd[5] = {0x34, 0x00, 0x1f, 0x00, 0x00};
	uint8_t i;
	for(i = 0; i < 5; i++)
	{ 
...
{
	uint8_t bufCmd[5] = {0x34, 0x00, 0x00, 0x00, 0x00};
	uint8_t i;
	for(i = 0; i < 5; i++)
	{ 
		while (USART_GetFlagStatus(UART4, USART_FLAG_TC) == RESET);//等待发送完成
